...
echo "  git push origin cmd/bowline/$version transport/websocket/$version mcp/$version agent/$version playground/$version contracttest/$version adapters/fiber/$version gateway/$version registry/$version"
