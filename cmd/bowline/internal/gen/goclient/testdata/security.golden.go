...
// Admin calls admin.
func (c *Client) Admin(ctx context.Context, in In) (In, error) {
	var out In
	err := c.call(ctx, "admin", http.MethodPost, in, &out)
	return out, err
}

// Get calls get.
func (c *Client) Get(ctx context.Context, in In) (In, error) {
	var out In
...
// Ping calls ping.
func (c *Client) Ping(ctx context.Context, in In) (In, error) {
	var out In
	err := c.call(ctx, "ping", http.MethodGet, in, &out)
	return out, err
}
