...
// Send calls send.
func (c *Client) Send(ctx context.Context, in ID) (Invoice, error) {
	var out Invoice
	err := c.call(ctx, "send", http.MethodPost, in, &out)
	return out, err
}

// Void calls void.
func (c *Client) Void(ctx context.Context, in ID) (Invoice, error) {
	var out Invoice
	err := c.call(ctx, "void", http.MethodPost, in, &out)
	return out, err
}
