...
func (c *Client) Get(ctx context.Context, in ID) (Item, error) {
	var out Item
...
// Hidden calls hidden.
func (c *Client) Hidden(ctx context.Context, in ID) (Item, error) {
	var out Item
	err := c.call(ctx, "hidden", http.MethodGet, in, &out)
	return out, err
}

// Remove calls remove.
func (c *Client) Remove(ctx context.Context, in ID) error {
	return c.call(ctx, "remove", http.MethodPost, in, nil)
}
