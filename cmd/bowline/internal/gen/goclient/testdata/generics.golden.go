...
type Report struct {
	...
	Ints   Range_int64          `json:"ints"`
	Floats Range_float64        `json:"floats"`
	Scores Page[Range_int32]    `json:"scores"`
}
...
// Get calls get.
func (c *Client) Get(ctx context.Context, in Page[User]) (Report, error) {
	var out Report
