...
func (g *generator) imports() string {
	...
	runtime := g.pick("BigInt", "DurationNs", "Empty")
	runtime = append(runtime, "CallOptions", "Method", "SyncTransport", "Transport")
	slices.Sort(runtime)
	b.WriteString("from bowline_client import ")
	b.WriteString(strings.Join(runtime, ", "))
	b.WriteString("\n")
	pyd := g.pick("AnyUrl", "Base64Bytes", "Field", "JsonValue")
	pyd = append(pyd, "BaseModel", "ConfigDict")
	slices.Sort(pyd)
