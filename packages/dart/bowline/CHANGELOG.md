...
- First release: `Transport` with `call`, `subscribe`, and `upload`, `BowlineException` with the sixteen codes and issues, `Empty`, decoding helpers, and validation rules for generated Dart clients.
