...
export const contract = {
  ...
  procedures: {
    ...
    "invoices.create": { kind: "mutation", method: "POST", output: "Invoice", path: "invoices" },
    "invoices.get": { kind: "query", method: "GET", output: "Invoice", path: "invoices/{id}" },
    "invoices.list": { kind: "query", method: "GET", output: "Page<Invoice>", path: "invoices" },
    "invoices.void": { kind: "mutation", method: "DELETE", output: "Invoice", errors: ["InvoiceLocked"], path: "invoices/{id}" },
